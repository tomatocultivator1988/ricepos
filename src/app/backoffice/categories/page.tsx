        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 gap-3 lg:hidden">
            {loading ? (
              ...
              <div className="rounded-2xl border-2 border-brewhas-700/50 bg-brewhas-900/60 backdrop-blur-xl p-8 text-center text-stone-500 shadow-md">No categories found</div>
            ) : (
              filtered.map((cat) => (
                  ...
                  <div className="flex justify-between items-center text-xs">
                    <span className="flex items-center gap-1.5 text-stone-500">
                      {cat.color ? (
                        ...
                        <span className="text-stone-500">No color</span>
                      )}
                    </span>
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-transparent hover:bg-transparent">
                  ...
                  <TableHead className="text-xs font-semibold uppercase text-primary">Sort Order</TableHead>
                  <TableHead className="text-xs font-semibold uppercase text-primary">Color</TableHead>
              ...
              <div className="grid gap-4 py-2">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="grid gap-2">
                    ...
                    <Input id="sortOrder" type="number" step="1" min="0" value={form.sortOrder} onChange={(e) => setForm({ ...form, sortOrder: e.target.value })} className="bg-gold-100" />
                  </div>
                  <div className="grid gap-2">
                    <Label htmlFor="color">Color</Label>
                    <Input id="color" value={form.color} onChange={(e) => setForm({ ...form, color: e.target.value })} placeholder="#6366f1" className="bg-gold-100" />
                  </div>
                </div>
              </div>
              <DialogFooter>
