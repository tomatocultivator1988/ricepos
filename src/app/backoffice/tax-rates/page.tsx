        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 gap-3 lg:hidden">
            {loading ? (
              ...
              <div className="rounded-2xl border-2 border-brewhas-700/50 bg-brewhas-900/60 backdrop-blur-xl p-8 text-center text-stone-500 shadow-md">No tax rates found</div>
            ) : (
              filtered.map((tr) => (
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-transparent hover:bg-transparent">
                  ...
                  <TableHead className="text-xs font-semibold uppercase text-primary">Rate (%)</TableHead>
            ...
            <DialogContent className="rounded-2xl bg-gold-200/90 border-amber-300/60 text-stone-800 p-5">
              ...
              <div className="grid gap-4 py-2">
                ...
                <div className="grid gap-2">
                  ...
                  <Input id="rate" type="number" step="0.01" min="0" value={form.rate} onChange={(e) => setForm({ ...form, rate: e.target.value })} placeholder="e.g. 8" className="bg-gold-100" />
                </div>
              </div>
              <DialogFooter>
